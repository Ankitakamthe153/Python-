...
#face_recognizer.write('E:/Face Recogition/trainingData.yml')


# uncomment these lines while running the code from second time onwards
face_recognizer=cv2.face.LBPHFaceRecognizer_create()
face_recognizer.read('E:/Face Recogition/trainingData.yml')

name = {0:'Siddhardhan'} # creating dictionary containing names for label
